    ...
    <div className='fixed w-full h-{80px} flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
      ...
      {/*Menu*/}
            <ul className='hidden md:flex'>
                ...
                <li> <Link to = "about" smooth = {true} duration = {500}>About</Link>
                </li>
                <li> <Link to = "skills" smooth = {true} duration = {500}>Skills</Link>
                </li>
                <li> <Link to = "work" smooth = {true} duration = {500}>Work</Link>
                </li>
     ...
     {!nav ? <FaBars /> :<FaTimes />}
        ...
        <li><Link onClick={handleClick} to = "home" smooth = {true} duration = {500}>Home</Link></li>
                <li className='py-6 text-4xl'><Link  onClick={handleClick} to = "about" smooth = {true} duration = {500}>About</Link>
                </li>
